  ...
  return (
    <div className="relative min-h-screen bg-white font-sans overflow-hidden pt-28">
      ...
      <section className="flex flex-col items-center justify-center text-center min-h-[60vh] pt-20 md:pt-36 pb-12 md:pb-16 px-4">
        ...
        <Link to="/campus-map" className="inline-block px-6 md:px-8 py-3 md:py-4 bg-[#00C6A7] text-white rounded-lg font-bold text-base md:text-lg hover:bg-[#009e87] hover:text-white transition-colors duration-200">Explore Campus Map</Link>
      </section>
      ...
      <section className="container mx-auto px-4 md:px-16 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
          {features.map((feature) => (
            <Link to={feature.link} key={feature.name} className="bg-white rounded-lg border-2 border-gray-200 p-8 flex flex-col items-center text-center transition-colors duration-200 group hover:border-gray-300">
