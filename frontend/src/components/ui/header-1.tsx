	...
	const links = token && user ? [
		...
		},
		{
			...
			items: [
				...
				{ label: 'Clubs Recruitment', href: '/clubs-recruitment' },
		...
		>
			...
			<MobileMenu open={open} className="flex flex-col justify-between gap-2">
				...
				<div className="flex flex-col gap-2">
					{token && user ? (
						<>
							<Button variant="outline" className="w-full bg-transparent" onClick={() => navigate('/profile')}>
								{user.name || 'Profile'}
							</Button>
