        ...
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full py-2.5 px-4 rounded-lg text-sm font-bold text-white bg-[#181818] hover:bg-[#00C6A7] transition-colors duration-200 min-h-touch ${(loading || !!emailError) ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
